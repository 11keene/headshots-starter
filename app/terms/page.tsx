  ...
  return (
    <main className="min-h-screen bg-background px-4 py-12">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="text-gray-700 mb-4">
          These Terms are governed by and construed in accordance with the laws of Georgia/United States, without regard 
          to its conflict of laws principles.
        </p>

        {/* Link back to home or any other place */}
        <div className="mt-12">
          <Link href="/overview" className="text-muted-gold hover:underline">
            ← Back to Home
          </Link>
        </div>
      </div>
